...
inputs = {
  ...
  requester_name_tag = "VPC peering connection to Fostermade"

  accepter_owner_id = "509573027517" 
  accepter_region = "us-west-2"
  accepter_vpc_id = "vpc-0ec0445c25bbc16d3" # TODO any way to clean this up? maybe not without STS:assumeRole
  accepter_cidr_block = "172.20.0.0/16" 
